...
//+kubebuilder:rbac:groups=appmesh.k8s.aws,resources=sidecars,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=appmesh.k8s.aws,resources=sidecars/status,verbs=get;update;patch
