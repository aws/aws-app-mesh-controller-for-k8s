...
function setup_eks_cluster {
    eksctl create cluster --name $CLUSTER_NAME --region us-west-2 --version $K8S_VERSION --nodes-min 2 --nodes-max 3 --nodes 2 --auto-kubeconfig --full-ecr-access --appmesh-access
