...
// Source: /home/ricejoe/go/pkg/mod/k8s.io/apimachinery@v0.32.3/pkg/conversion/converter.go
...
func (m *MockScope) Convert(src, dest interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Convert", src, dest)
	ret0, _ := ret[0].(error)
	return ret0
}

// Convert indicates an expected call of Convert.
func (mr *MockScopeMockRecorder) Convert(src, dest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Convert", reflect.TypeOf((*MockScope)(nil).Convert), src, dest)
}
