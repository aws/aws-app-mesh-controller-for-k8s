...
// Source: pkg/virtualnode/membership_designator.go
...
func (m *MockMembershipDesignator) Designate(ctx context.Context, pod *v1.Pod) (*v1beta2.VirtualNode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Designate", ctx, pod)
...
func (mr *MockMembershipDesignatorMockRecorder) Designate(ctx, pod interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Designate", reflect.TypeOf((*MockMembershipDesignator)(nil).Designate), ctx, pod)
}
