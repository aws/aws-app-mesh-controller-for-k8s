...
type AppMeshAPI interface {
	...
	DeleteMeshPolicy(*appmesh.DeleteMeshPolicyInput) (*appmesh.DeleteMeshPolicyOutput, error)
	DeleteMeshPolicyWithContext(aws.Context, *appmesh.DeleteMeshPolicyInput, ...request.Option) (*appmesh.DeleteMeshPolicyOutput, error)
	DeleteMeshPolicyRequest(*appmesh.DeleteMeshPolicyInput) (*request.Request, *appmesh.DeleteMeshPolicyOutput)
	...
	GetMeshPolicy(*appmesh.GetMeshPolicyInput) (*appmesh.GetMeshPolicyOutput, error)
	GetMeshPolicyWithContext(aws.Context, *appmesh.GetMeshPolicyInput, ...request.Option) (*appmesh.GetMeshPolicyOutput, error)
	GetMeshPolicyRequest(*appmesh.GetMeshPolicyInput) (*request.Request, *appmesh.GetMeshPolicyOutput)
	...
	PutMeshPolicy(*appmesh.PutMeshPolicyInput) (*appmesh.PutMeshPolicyOutput, error)
	PutMeshPolicyWithContext(aws.Context, *appmesh.PutMeshPolicyInput, ...request.Option) (*appmesh.PutMeshPolicyOutput, error)
	PutMeshPolicyRequest(*appmesh.PutMeshPolicyInput) (*request.Request, *appmesh.PutMeshPolicyOutput)
